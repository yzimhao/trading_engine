...
type TradVariety struct {
	ID             int32        `gorm:"primaryKey;autoIncrement" json:"id"`
	Symbol         string       `gorm:"type:varchar(100); not null; uniqueIndex:symbol_idx" json:"symbol"`
	Name           string       `gorm:"type:varchar(250); not null" json:"name"`
	TargetId       int          `gorm:"default:0; uniqueIndex:symbol_base_idx" json:"target_id"`
	BaseId         int          `gorm:"default:0; uniqueIndex:symbol_base_idx" json:"base_id"`
