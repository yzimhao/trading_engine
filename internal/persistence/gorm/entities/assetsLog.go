...
type AssetLog struct {
	...
	Amount        types.Numeric   `gorm:"type:decimal(40,20);default:0" json:"amount"`                   // 变动数
	AfterBalance  types.Numeric   `gorm:"type:decimal(40,20);default:0" json:"after_balance"`            // 变动后
