...
func initdb() {
	...
	app.DatabaseInit(config.App.Database.Driver, strings.Replace(config.App.Database.DSN, "haotrader", "test1", -1), config.App.Database.ShowSQL, config.App.Database.Prefix)
