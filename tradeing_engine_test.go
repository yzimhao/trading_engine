...
func TestTradeFunc(t *testing.T) {
	btcusdt.PushNewOrder(NewBidItem("uid1", decimal.NewFromFloat(1.1), decimal.NewFromFloat(1.2), 1112))
	...
	btcusdt.PushNewOrder(NewAskItem("uid2", decimal.NewFromFloat(1.1), decimal.NewFromFloat(1.2), 1112))
	...
	//测试成交价格和数量
	btcusdt.PushNewOrder(NewBidItem("uid3", decimal.NewFromFloat(1.01), decimal.NewFromFloat(3.0), 1112))
	btcusdt.PushNewOrder(NewAskItem("uid4", decimal.NewFromFloat(0.9), decimal.NewFromFloat(1.0), 1113))
	tradeLog = <-btcusdt.ChTradeResult
	...
	btcusdt.PushNewOrder(NewBidItem("uid5", decimal.NewFromFloat(1.02), decimal.NewFromFloat(3.0), 1114))
	btcusdt.PushNewOrder(NewAskItem("uid6", decimal.NewFromFloat(0.1), decimal.NewFromFloat(5.0), 1115))
	tradeLog = <-btcusdt.ChTradeResult
